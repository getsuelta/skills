...
| 402 `{"error":"trial_exhausted","message":"...","contact_whatsapp":"...","contact_url":"https://wa.me/...","allowance":500,"sent":500}` | Self-service free trial used up. Gated: flows create/delete, draft (+tools), test-chat, toggle, canary, audience, publish, revert, messages/template. Open: every GET, context-preview, on-tap/eval, profile, trial, whatsapp, integrations, settings, keys | Don't retry. Tell the user `message` once with `contact_url`; continue with read-only work. Suelta lifts the limit by hand after the user writes (applies within a minute) |
